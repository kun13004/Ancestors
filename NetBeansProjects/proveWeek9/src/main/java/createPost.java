...
public class createPost extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        SimpleDateFormat ft = new SimpleDateFormat("MM/dd/yyyy 'at' hh:mm");
        Date date = new Date();
        String daDate = ft.format(date);
        
        Post newPost = new Post(post, username, daDate);

        savedPosts posts = new savedPosts("myFile.txt");
